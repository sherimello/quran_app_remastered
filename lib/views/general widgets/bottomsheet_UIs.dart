...
class BottomsheetUIs extends GetxController {
  ...
  BottomsheetUIs(this.size);

  final RxBool isDarkMode = false.obs;
  final RxDouble arabicFontSize = 21.0.obs;
  final RxDouble englishFontSize = 15.0.obs;
  ...
  Future<void> onInit() async {
    ...
    // Arabic font size
    if (prefs.containsKey("arabicFontSize")) {
      arabicFontSize.value = prefs.getDouble("arabicFontSize")!;
    } else {
      arabicFontSize.value = size.width * 0.061;
    }

    // English font size
    if (prefs.containsKey("englishFontSize")) {
      englishFontSize.value = prefs.getDouble("englishFontSize")!;
    } else {
      englishFontSize.value = 15.0;
    }
  }
  ...
  Widget addBookMarkWidget(
    ...
    final shouldShowDeletionUI = false.obs;
    final deletionIndex = 0.obs;
    final bookMarkFolderIndex = 0.obs;
        ...
        child: Column(
          children: [
            Obx(
                ...
                curve: Curves.linearToEaseOut,
                padding:
                EdgeInsets.all(shouldShowDeletionUI.value ? 21 : 0),
                child: GestureDetector(
                  onTap: () {
                    shouldShowDeletionUI.value = false;
                    deletionIndex.value = 0;
                  ...
                  child: AnimatedContainer(
                    width: shouldShowDeletionUI.value
                        ? size.width
                        : 0,
                    height: shouldShowDeletionUI.value
                        ? size.width * .11
                        : 0,
                    duration: const Duration(milliseconds: 555),
                    curve: Curves.linearToEaseOut,
            ...
            GestureDetector(
              onTap: () {
                bookmarkViewModel.value
                    .insertData(textEditingController.text);
              },
              child: Container(
                width: size.width * .55,
                height: size.width * .11,
  ...
  Widget listOfBookMarkVersesWidget(
    ...
    Future<void> init() async {
      await bookmarkViewModel.fetchBookmarkFolderNames();
      length.value =
          bookmarkViewModel.bookmarkModel.value.folderName.length;
    }
  ...
  Widget verseOptions(
    ...
    final BookmarkViewModel _bm = Get.put(BookmarkViewModel());
    final FavoriteVersesViewModel _fv = Get.put(FavoriteVersesViewModel());
                ...
                child: GestureDetector(
                  onTap: () async {
                    Get.bottomSheet(
                      ...
                      isScrollControlled: true, // ← must for scrollable sheets :contentReference[oaicite:2]{index=2}
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async {
                          ...
                          prefs.setDouble(
                            "arabicFontSize",
                            fontSizeController.arabicFontSize.value,
                          );
                        },
                        child: Container(
                          width: size.width * .1,
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async {
                          ...
                          prefs.setDouble(
                            "englishFontSize",
                            fontSizeController.englishFontSize.value,
                          );
                        },
                        child: Container(
                          width: size.width * .1,
