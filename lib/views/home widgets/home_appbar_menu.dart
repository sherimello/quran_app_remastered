...
class HomeAppbarMenu extends StatelessWidget {
  ...
  const HomeAppbarMenu(
      ...
      this.shouldShowSurahInfo = false,
      this.surahName = "",
      this.verseNumber = ""});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => AnimatedPadding(
          padding: EdgeInsets.only(
            top: !animatedMenuIconAnimationController.isPlaying.value ? 0 : 21,
            right:
                !animatedMenuIconAnimationController.isPlaying.value ? 0 : 21,
            left: !animatedMenuIconAnimationController.isPlaying.value ? 0 : 21,
          ),
            ...
            child: Stack(
              ...
              children: [
                ...
                AnimatedOpacity(
                  duration: const Duration(milliseconds: 355),
                  curve: Curves.linearToEaseOut,
                  opacity: !animatedMenuIconAnimationController.isPlaying.value
                      ? 1
                      : 0,
